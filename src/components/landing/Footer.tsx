      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center space-x-4 mt-6">
              <a
                ...
                className="p-2 rounded-lg bg-white/5 text-white/60 hover:text-[#D4A017] hover:bg-white/10 transition-all"
                aria-label="LinkedIn"
              >
              ...
              {isSubscribed ? (
                ...
                <form onSubmit={handleSubscribe} className="space-y-3">
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white placeholder-white/40 text-sm focus:outline-none focus:border-[#D4A017] focus:ring-1 focus:ring-[#D4A017] transition-all"
                    required
                  />
                  <button
                    type="submit"
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4 invisible">
                Contact
              </h3>
              <ul className="space-y-3">
                <li>
            ...
            <div className="md:text-right">
              <Link
                href="/contact"
                className="inline-flex items-center text-sm font-semibold text-[#D4A017] hover:text-[#F0C040] transition-colors"
              >
                Get in Touch
